...
![Diagram of an RDF statement](/rdf/static/introduction/example1.png)
...
![Diagram of an RDF statement example2](/rdf/static/introduction/example2.png)
...
![Diagram showing a more complex example of an RDF graph](/rdf/static/introduction/example3.png)
...
![Diagram showing the use of URIs in RDF data](/rdf/static/introduction/example4.png)
